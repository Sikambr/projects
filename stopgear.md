...
В проекте реализован механизм загрузки правил и билетов из Internet, которые, затем парсятся, написанным на Java парсером, создаются Delphi-ресурсы, и прикомпилируются к исполняемому файлу.
